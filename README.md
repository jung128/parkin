...
### 3. 폰트 사용 
- **메인 폰트**로 **어그로체/32px,24px/Bold/#2C2C2C** 폰트를 사용하여 곡선과 사선의 조합으로 주목성을 향상 하고자 하였습니다.
- **서브 폰트**로 **수트/24px,16px,8px/Regular/#F4F4F4** 폰트를 사용하여 깔끔한 디자인을 통한 가독성을 향상 하고자 하였습니다.
